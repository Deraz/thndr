  ...
  return (
    <div
      className={cn(
        ...
        'cursor-pointer hover:border-primary-300 dark:hover:border-primary-600 hover:bg-gray-50 dark:hover:bg-gray-700'
      )}
    ...
    >
      ...
      <div className="mt-4 text-center">
        <span className="text-xs text-gray-500 dark:text-gray-400">Click to view live data</span>
      </div>
    </div>
  )
}
